...
1.upto(9)   { |i| Issue.create(id: i, subject: Faker::Lorem.unique.word, text: Faker::Lorem.unique.sentence, repository_id: i) }
10.upto(14) { |i| Issue.create(id: i, subject: Faker::Lorem.unique.word, text: Faker::Lorem.unique.sentence, repository_id: 1) }
15.upto(20) { |i| Issue.create(id: i, subject: Faker::Lorem.unique.word, text: Faker::Lorem.unique.sentence, repository_id: i-14) }
